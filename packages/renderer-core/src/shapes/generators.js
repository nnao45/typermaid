 ...
 * Mermaid: A[[Text]]
 */
export const subroutine = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const { width, height } = calculateTextBox(
    opts.text,
    opts.fontSize,
 ...
 * Mermaid: A[(Text)]
 */
export const cylindrical = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const { width, height } = calculateTextBox(
    opts.text,
    opts.fontSize,
 ...
 * Mermaid: A[/Text/]
 */
export const parallelogram = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const { width: baseWidth, height } = calculateTextBox(
    opts.text,
    opts.fontSize,
 ...
 * Mermaid: A[\Text\]
 */
export const parallelogram_alt = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const { width: baseWidth, height } = calculateTextBox(
    opts.text,
    opts.fontSize,
 ...
 * Mermaid: A[/Text\]
 */
export const trapezoid = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const { width, height } = calculateTextBox(
    opts.text,
    opts.fontSize,
 ...
 * Mermaid: A[\Text/]
 */
export const trapezoid_alt = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const { width, height } = calculateTextBox(
    opts.text,
    opts.fontSize,
 ...
 * Mermaid: A(((Text)))
 */
export const double_circle = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const textMetrics = calculateTextBox(
    opts.text,
    opts.fontSize,
 ...
 * Mermaid: A>Text]
 */
export const asymmetric = (options) => {
  const opts = { ...DEFAULT_SHAPE_OPTIONS, ...options };
  const { width: baseWidth, height } = calculateTextBox(
    opts.text,
    opts.fontSize,
