 ...
 */
export function dotted_arrow(options) {
 ...
 */
export function dotted_open(options) {
 ...
 */
export function dotted_cross(options) {
 ...
 */
export function thick_arrow(options) {
 ...
 */
export function thick_open(options) {
  const opts = { ...options, thickness: (options.thickness || 2) * 2 };
  return open(opts);
}
/**
 ...
 */
export function thick_cross(options) {
  const opts = { ...options, thickness: (options.thickness || 2) * 2 };
  return cross(opts);
}
/**
 * Invisible edge: A ~~~ B
 */
export function invisible(options) {
  const opts = { ...DEFAULT_EDGE_OPTIONS, ...options };
