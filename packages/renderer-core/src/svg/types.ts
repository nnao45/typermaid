...
export type SVGElement =
  | { type: 'path'; props: SVGPathElement }
  | { type: 'rect'; props: SVGRectElement }
  | { type: 'circle'; props: SVGCircleElement }
  | { type: 'ellipse'; props: SVGEllipseElement }
  | { type: 'line'; props: SVGLineElement }
  | { type: 'text'; props: SVGTextElement }
  | { type: 'g'; props: SVGGroupElement };
