...
import type { SVGDocument, SVGElement, ViewBox } from './types.js';
 ...
 */
function renderElement(element: SVGElement, indent = 0): string {
 ...
 */
export function renderSVG(doc: SVGDocument): string {
