...
export const ColorSchema = z.union([
    ...
    z
        .string()
        .regex(/^rgb\(\s*([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])\s*,\s*([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])\s*,\s*([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])\s*\)$/), // rgb (0-255)
    z
        .string()
        .regex(/^rgba\(\s*([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])\s*,\s*([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])\s*,\s*([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])\s*,\s*(0|1|0?\.[0-9]+)\s*\)$/), // rgba (0-255, 0-1)
    z.enum([
        // CSS named colors
        'black',
        'white',
