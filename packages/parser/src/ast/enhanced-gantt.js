 ...
 */
export class EnhancedGanttDiagramAST {
    // AST properties
    type = 'GanttDiagram';
    diagram;
    loc;
     ...
     */
    addTask(id, name, startDate, endDate, status) {
     ...
     * @returns TaskID for method chaining
     */
    addMilestone(id, description, date, status) {
        const taskId = createTaskID(id);
...
//# sourceMappingURL=enhanced-gantt.js.map